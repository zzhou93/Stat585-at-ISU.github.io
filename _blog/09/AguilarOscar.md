...
##                           location station_id latitude longitude
## 1 Ames, Ames Municipal Airport, IA       KAMW 41.99056 -93.61889
##           observation_time_rfc822 temp_f temp_c relative_humidity wind_dir
## 1 Wed, 03 Apr 2019 12:53:00 -0500     54   12.2                45    South
##   wind_degrees wind_mph
## 1          180      9.2
```
...
Color:
<!--html_preserve-->
<h1 style="background-color:DodgerBlue; color:white">Machine learning is cool!</h1>
<!--/html_preserve-->
...
Link:
<!--html_preserve-->
<a href="https://conferences.oreilly.com/strata/strata-ca" target="_blank">STRATA San Francisco</a>
<!--/html_preserve-->
...
![center](./../figure/09/AguilarOscar/unnamed-chunk-2-1.png)
