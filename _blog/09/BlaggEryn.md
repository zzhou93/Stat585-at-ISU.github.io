...
2. Which HTML tags did you investigate? Describe how to format at least 3 separate pieces of a document using HTML tags.
 ...
 <!--html_preserve-->
<h1 style="background-color:rgb(60, 179, 113);color:Yellow;border:10px dashed #F10909">Testing.</h1>
<!--/html_preserve-->
...
<a href="https://findtheinvisiblecow.com/" target="_blank">some fun things about some fun things  website</a>
<!--/html_preserve-->
>>>>>>> blog 9 posts up
...
=======
  ...
  <tr>
    <td>Tag</td>
    <td>the key is to hide.</td>
  </tr>
  <tr>
    <td>hide and go seek</td>
    <td>wish you were small.</td>
  </tr>
</table>
<!--/html_preserve-->
...
R code chunks are formatted with pre class="r" tags. Style parameters including "background color", and "border". The actual text is stored within a span class="hljs" tag, which has a number of style parameters to indicate the color and emphasis of the text.    

    - What differences are there in the HTML markup for R code chunks and R output blocks?

The output blocks do not fall under the \<pre class="r"> tag and follow the default class. 
...
![center](./../figure/09/BlaggEryn/unnamed-chunk-2-1.png)
