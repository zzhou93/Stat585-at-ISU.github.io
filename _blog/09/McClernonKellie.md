...
```
##   station_id latitude longitude         observation_time temp_f weather
## 1       KCXW  35.0199  -92.5551 Apr 3 2019, 12:55 pm CDT     70    Fair
##   wind_mph wind_dir
## 1     12.7    South
```
...
![center](.///upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Polar_bears_near_north_pole.jpg/220px-Polar_bears_near_north_pole.jpg)

```r
knitr::include_graphics(bearpics[7])
```

![center](.///upload.wikimedia.org/wikipedia/commons/thumb/a/af/Female_polar_bear_%28Ursus_maritimus%29_with_cub%2C_Svalbard.jpg/220px-Female_polar_bear_%28Ursus_maritimus%29_with_cub%2C_Svalbard.jpg)

```r
knitr::include_graphics(bearpics[12])
```

![center](.///upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Polar_bear_arctic.JPG/220px-Polar_bear_arctic.JPG)
